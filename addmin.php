            ...
            <table width="1000" border="1">
                ...
                <tr>
                    <td colspan="8">
                        <div id="paging">
                            <ul>
                                <li><span><A HREF="addaccount.php?id=<?php echo $row["idDepart"]; ?>">เพิ่ม</A></span>
                                </li>
                            </ul>
                </tfoot>
                </td>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            <td>
                                <div align="center"><?php echo $row["UserID"]; ?></div>
                            </td>
                            <td><?php echo $row["userName"]; ?></td>
                            <td><?php echo $row["password"]; ?></td>
                            <td><?php echo $row["province"]; ?></td>
                            <td><?php echo $row["nameDepart"]; ?></td>
                            <td><A HREF="deleteaccount.php?id=<?php echo $row["idDepart"]; ?>">ลบ</A></td>
                            <td><a href="editaccount.php?idDepart=<?php echo $row["idDepart"]; ?>">แก้ไข</a></td>
                        </tr>
                        </tbody>
                        <?php
                    }
