...
CREATE TABLE `amphur` (
  ...
  `AMPHUR_CODE` varchar(4) collate utf8_general_ci NOT NULL,
  `AMPHUR_NAME` varchar(150) collate utf8_general_ci NOT NULL,
  `GEO_ID` int(5) NOT NULL default '0',
  `PROVINCE_ID` int(5) NOT NULL default '0',
  PRIMARY KEY  (`AMPHUR_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=1023 ;
...
CREATE TABLE `district` (
  ...
  `DISTRICT_CODE` varchar(6) collate utf8_general_ci NOT NULL,
  `DISTRICT_NAME` varchar(150) collate utf8_general_ci NOT NULL,
  `AMPHUR_ID` int(5) NOT NULL default '0',
  `PROVINCE_ID` int(5) NOT NULL default '0',
  `GEO_ID` int(5) NOT NULL default '0',
  PRIMARY KEY  (`DISTRICT_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=8914 ;
...
CREATE TABLE `geography` (
  ...
  `GEO_NAME` varchar(255) collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`GEO_ID`)
...
CREATE TABLE `province` (
  ...
  `PROVINCE_CODE` varchar(2) collate utf8_general_ci NOT NULL,
  `PROVINCE_NAME` varchar(150) collate utf8_general_ci NOT NULL,
  `GEO_ID` int(5) NOT NULL default '0',
  PRIMARY KEY  (`PROVINCE_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=78 ;
